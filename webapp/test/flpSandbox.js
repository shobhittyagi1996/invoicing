		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoicing",
									"targetURL": "#comsapinvoicing-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapinvoicing-display": {
								"semanticObject": "comsapinvoicing",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.invoicing",
									"url": sap.ui.require.toUrl("com/sap/invoicing")
								}
							}
						}
					}
